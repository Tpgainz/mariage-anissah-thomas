...
type Booklet = {
  ...
  Ordre_de_la_messe: Messe;
};
type Informations = {
  titre: string;
  date: string;
  lieu: string;
  Célébrants: { [key: string]: string[] };
};
...
export const data: Booklet = {
  informations: {
    titre: "Messe de mariage de Anissah et Thomas",
    date: "Mercredi 24 Juillet 2024",
    lieu: "Eglise Saint Michel, 6 rue d Aboville, 29200 Brest",
    Célébrants: {
      Prêtre: ["Père Joseph"],
      Assistante_liturgique: ["Sœur Marie"],
      Chant: ["Gabrielle"],
      Violoncelle: ["Maïwenn"],
    },
  },
  Ordre_de_la_messe: {
    "Accueil et ouverture de la célébration": {
      "Entrée et mise en place des invités": 5,
      "Entrée des futurs époux et leur cortège": 10,
      "Parole d'accueil du prêtre": 1,
      "Chant d'entrée": {
    ...
    "Liturgie de la Parole": {
      ...
      Homélie: 1,
      "Morceau de musique au Violoncelle": 4,
    },
    "Liturgie du mariage": {
      "Profession de foi": 2,
      "Appel des témoins": 4,
      ...
      "Réception du consentement": 1,
      "Bénédiction et remise des alliances": 1,
      "Chant de louange": {
    ...
    "Liturgie Eucharistique": {
      ...
      "Distribution de la Communion": 4,
      "Chant de communion": {
